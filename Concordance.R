...
Concordance = function(GLM.binomial) {
  ...
  #subset of outcomes where the event actually happened
  ones = outcome_and_fitted_col[outcome_and_fitted_col[,1] == 1,]
  #subset of outcomes where the event didn't actually happen
  ...
  #store concordant, discordant, and tie pair evaluations in columns
